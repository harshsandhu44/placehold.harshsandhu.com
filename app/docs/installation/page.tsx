      ...
      <div className="mx-auto w-full min-w-0">
        ...
        <div className="mt-8 space-y-6">
          <p className="leading-7 not-first:mt-6">
            Placehold is primarily an API service, so there is nothing to
            &quot;install&quot; in the traditional sense of an npm package.
            However, you can easily integrate it into your projects by using the
            API endpoints directly in your HTML `img` tags or fetching data via
            JavaScript.
          </p>
